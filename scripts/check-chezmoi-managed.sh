...
require_managed=(
  ...
  ".claude/skills/pr-review/scripts/wait-claude-review.py"
  ".claude/skills/review/SKILL.md"
  ".claude/skills/setup-pr-review-workflow/SKILL.md"
  ".claude/skills/setup-pr-review-workflow/templates/claude-review.yml"
